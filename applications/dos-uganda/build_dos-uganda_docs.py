...
def build_pptx():
    ...
    tb(s, Inches(0.55), SH - Inches(2.65), Inches(12), Inches(0.7), DOC_TITLE, size=22, bold=True, color="FFFFFF")
    tb(s, Inches(0.55), SH - Inches(1.95), Inches(12), Inches(0.35),
       "FairBanks Community Health Intelligence Platform (FCHIP)", size=13, bold=True, italic=True, color="F2C79B")
    tb(s, Inches(0.55), SH - Inches(1.5), Inches(12), Inches(0.35), SUBTITLE, size=12, italic=True, color="D0E8E8")
    ...
    for i, (roman, title, body, img_key) in enumerate(sections, start=2):
        ...
        if img_key:
            ...
            tb(s, Inches(6.5), Inches(1.15), Inches(6.4), Inches(5.6), body, size=19, color=SLATE)
        else:
            tb(s, Inches(0.55), Inches(1.15), Inches(12.2), Inches(5.8), body, size=20, color=SLATE)
        footer(s, i)
